...
var TreeTableHeader = /*#__PURE__*/function (_Component) {
  ...
  _createClass(TreeTableHeader, [{
    ...
    value: function onHeaderClick(event, column) {
      if (column && column.props.sortable) {
    ...
    value: function onFilterInput(e, column) {
      ...
      if (column && column.props.filter && this.props.onFilter) {
    ...
    value: function renderHeaderCell(column, options) {
      ...
      if (column && column.props.filter && options.renderFilter) {
      ...
      if (options.filterOnly) {
        ...
        var singleSorted = column && column.props.field === this.props.sortField;
        var multipleSorted = multiSortMetaData !== null;
        var sorted = column && column.props.sortable && (singleSorted || multipleSorted);
        var sortOrder = 0;
        ...
        var className = (0, _ClassNames.classNames)(column && column.props.headerClassName || column && column.props.className, {
          'p-sortable-column': column && column.props.sortable,
          'p-highlight': sorted,
          'p-resizable-column': this.props.resizableColumns
        });
        var resizer = this.renderResizer(column);
        return /*#__PURE__*/_react.default.createElement("th", {
          key: column && column.columnKey || column && column.field || options.index,
          className: className,
          style: column && column.props.headerStyle || column && column.props.style,
          tabIndex: column && column.props.sortable ? this.props.tabIndex : null,
          ...
          rowSpan:column &&  column.props.rowSpan,
          colSpan: column && column.props.colSpan,
        ...
        }, column && column.props.header), sortIconElement, sortBadge, filterElement);
      }
    }
  }, {
    key: "renderHeaderRow",
