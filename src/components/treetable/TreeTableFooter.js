  ...
  _createClass(TreeTableFooter, [{
    ...
    value: function renderFooterCell(column, index) {
      return /*#__PURE__*/_react.default.createElement("td", {
        ...
        className: column && column.props.footerClassName || column && column.props.className,
        style: column && column.props.footerStyle || column && column.props.style,
        rowSpan: column && column.props.rowSpan,
        colSpan: column && column.props.colSpan
      }, column && column.props.footer);
    }
  }, {
    key: "renderFooterRow",
    ...
    value: function hasFooter() {
      if (this.props.columnGroup) {
        ...
        for (var i = 0; i < this.props.columns.length; i++) {
          if (this.props.columns[i] && this.props.columns[i].props.footer) {
            return true;
          }
        }
      }
